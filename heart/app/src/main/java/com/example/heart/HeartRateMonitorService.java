...
public class HeartRateMonitorService extends Service {
    ...
    {
        Notification notification = new Notification(R.mipmap.ic_launcher, getString(R.string.Notify_Started),
                System.currentTimeMillis());
        PendingIntent pi = PendingIntent.getActivity(this, 0, new Intent(this, HeartRateMonitorActivity.class),
                PendingIntent.FLAG_CANCEL_CURRENT);
        //notification.setLatestEventInfo(this, getString(R.string.app_name), getString(R.string.Notify_Started_Body), pi);
