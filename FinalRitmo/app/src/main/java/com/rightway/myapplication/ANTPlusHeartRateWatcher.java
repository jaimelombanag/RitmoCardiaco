	...
	extends GenericWatcher implements IDeviceStateChangeReceiver, IPluginAccessResultReceiver<AntPlusHeartRatePcc>
{
    ...
    public void setConnected() {
        ...
        myact.connectButton.setImageResource(R.drawable.heart);
        myact.connectButton.setEnabled(true);
        myact.connectButton.setActivated(true);
        myact.setRecStatus(myact.getResources().getString(R.string.clickToRecord));
        myact.startStopButton.setImageResource(R.drawable.record);
    ...
    public void disconnect(boolean skipReleaseAccess) {
        ...
        myact.connectButton.setImageResource(R.drawable.ant_plus);
        myact.connectButton.setEnabled(true);
	...
	public void start() {
		if (isConnected()) {
			r = new Recording();
			super.start();
            myact.startStopButton.setImageResource(R.drawable.stop);
            myact.startStopButton.setEnabled(true);
